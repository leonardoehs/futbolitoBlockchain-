...
public class cliente extends javax.swing.JFrame {
    ...
    private void btnAgregarPadreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarPadreActionPerformed
        ...
        if (this.jTextField1.getText().trim().isEmpty()
            ...
            try {
                ...
                times_tamp = Long.toString(lastBlk.getTimeStamp());
                hashprev = lastBlk.getPreviousHash();
        ...
        if (this.listaTran.isEmpty()) {
            ...
            try {
                ...
                for (int i = 0; i < this.listaTran.size(); i++) {
                    ...
                    strLinea.append("\t\t\t\"timestamp\" : " + times_tamp + ",\n");
                    strLinea.append("\t\t\t\"nonce\" : " + hashnonce + ",\n");
                    strLinea.append("\t\t\t\"hash\" : \"" + hashactual + "\",\n");
                    strLinea.append("\t\t\t\"previous hash\" : \"" + hashprev + "\",\n");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        cad1 += "--- Mined ---\n"
                ...
                + "Hash:  " + blk.getHash() + "\n"
                + "---------------------------------------------------------------------------------------------------";
        hashactual = blk.getHash();
        hashnonce = blk.getNonce();
        ...
        this.jTextField7.setText("");
        this.jTextField8.setText("");
        this.tmPadre = (DefaultTableModel) jTable3.getModel();
        this.tmPadre.setRowCount(0);
        this.tmHijo = (DefaultTableModel) jTable4.getModel();
        this.tmHijo.setRowCount(0);
